...
let TemplatesService = class TemplatesService {
    ...
    async create(dto, userId) {
        ...
        if (existing) {
            throw new common_1.ConflictException(`Template for type ${dto.type} already exists`);
        }
    ...
    resolvePlaceholders(template, data) {
        ...
        result = result.replace(/\{\{program_name\}\}/g, data.programName || "General Fund");
        result = result.replace(/\{\{receipt_number\}\}/g, data.receiptNumber || "");
        return result;
    }
    async resolveWithOrgProfile(template, data) {
        ...
        result = result.replace(/\{\{org_phone\}\}/g, `${org.phone1} / ${org.phone2}`);
...
Asha Kuteer Foundation Team`,
            ...
            {
                type: client_1.TemplateType.BIRTHDAY,
...
📞 {{org_phone}} | 📧 {{org_email}}`,
            ...
            {
                type: client_1.TemplateType.ANNIVERSARY,
...
📞 {{org_phone}} | 📧 {{org_email}}`,
            ...
            {
                type: client_1.TemplateType.MEMORIAL,
...
📞 {{org_phone}} | 📧 {{org_email}}`,
            ...
            {
                type: client_1.TemplateType.FOLLOWUP,
...
📞 {{org_phone}} | 📧 {{org_email}}`,
            ...
            {
                type: client_1.TemplateType.PLEDGE_DUE,
