...
export declare class RolePermissionsService implements OnModuleInit {
    ...
    updateRolePermission(role: Role, module: string, action: string, allowed: boolean, updatedByUserId: string, ipAddress?: string, userAgent?: string): Promise<any>;
    ...
    updateSensitiveFieldConfig(module: string, fieldName: string, roles: Role[], updatedByUserId: string, ipAddress?: string, userAgent?: string): Promise<any>;
