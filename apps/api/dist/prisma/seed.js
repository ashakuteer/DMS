...
function generateDonorCode(index) {
...
async function main() {
    ...
    const beneficiary1 = await prisma.beneficiary.create({
        data: {
            ...
            homeType: client_1.HomeType.OLD_AGE,
            gender: 'FEMALE',
            approxAge: 72,
            ...
            status: client_1.BeneficiaryStatus.ACTIVE,
    ...
    const beneficiary2 = await prisma.beneficiary.create({
        data: {
            ...
            homeType: client_1.HomeType.ORPHAN_GIRLS,
            gender: 'FEMALE',
            dobMonth: 6,
            dobDay: 15,
    ...
    const beneficiary3 = await prisma.beneficiary.create({
        data: {
            ...
            homeType: client_1.HomeType.BLIND_BOYS,
            gender: 'MALE',
            dobMonth: 3,
            dobDay: 22,
    ...
    const donor1 = await prisma.donor.create({
        data: {
            ...
            incomeSpectrum: client_1.IncomeSpectrum.UPPER_MIDDLE,
            religion: 'Hindu',
            donationMethods: [client_1.DonationMethod.UPI, client_1.DonationMethod.BANK_TRANSFER],
            donationFrequency: client_1.DonationFrequency.MONTHLY,
            notes: 'Regular donor, prefers to donate on festivals',
            prefEmail: true,
            prefWhatsapp: true,
            prefReminders: true,
            category: client_1.DonorCategory.INDIVIDUAL,
            sourceOfDonor: client_1.SourceOfDonor.REFERRAL,
            pan: 'ABCDE1234F',
    ...
    const donor2 = await prisma.donor.create({
        data: {
            ...
            incomeSpectrum: client_1.IncomeSpectrum.HIGH,
            donationMethods: [client_1.DonationMethod.GPAY],
            donationFrequency: client_1.DonationFrequency.QUARTERLY,
            category: client_1.DonorCategory.INDIVIDUAL,
            sourceOfDonor: client_1.SourceOfDonor.SOCIAL_MEDIA,
            isSingleParent: true,
    ...
    const donor3 = await prisma.donor.create({
        data: {
            ...
            city: 'Hyderabad',
            state: 'Telangana',
            category: client_1.DonorCategory.CSR_REP,
            sourceOfDonor: client_1.SourceOfDonor.WEBSITE,
            donationMethods: [client_1.DonationMethod.BANK_TRANSFER, client_1.DonationMethod.CHEQUE],
            donationFrequency: client_1.DonationFrequency.YEARLY,
    ...
    const donor4 = await prisma.donor.create({
        data: {
            ...
            sourceOfDonor: client_1.SourceOfDonor.WALK_IN,
            donationFrequency: client_1.DonationFrequency.OCCASIONAL,
            createdById: staff.id,
            assignedToUserId: staff.id,
        },
    });
    const donor5 = await prisma.donor.create({
        data: {
            ...
            category: client_1.DonorCategory.WHATSAPP_GROUP,
            sourceOfDonor: client_1.SourceOfDonor.SOCIAL_MEDIA,
    ...
    await prisma.donorSpecialOccasion.createMany({
        data: [
            ...
            {
                donorId: donor1.id,
                type: client_1.OccasionType.DOB_SPOUSE,
                month: 7,
                day: 22,
    ...
    await prisma.sponsorship.create({
        data: {
            ...
            sponsorshipType: client_1.SponsorshipType.EDUCATION,
            amount: 5000,
            currency: 'INR',
            frequency: client_1.SponsorshipFrequency.MONTHLY,
    ...
    await prisma.sponsorship.create({
        data: {
            ...
            sponsorshipType: client_1.SponsorshipType.FOOD,
            amount: 3000,
            currency: 'INR',
            frequency: client_1.SponsorshipFrequency.MONTHLY,
    ...
    await prisma.sponsorship.create({
        data: {
            ...
            sponsorshipType: client_1.SponsorshipType.FULL,
            amount: 10000,
            currency: 'INR',
            frequency: client_1.SponsorshipFrequency.MONTHLY,
    ...
    await prisma.sponsorship.create({
        data: {
            ...
            amount: 5000,
            currency: 'INR',
            frequency: client_1.SponsorshipFrequency.QUARTERLY,
    ...
    await prisma.beneficiaryTimelineEvent.create({
        data: {
            beneficiaryId: beneficiary2.id,
            eventType: client_1.BeneficiaryEventType.ACHIEVEMENT,
    ...
    await prisma.beneficiaryTimelineEvent.create({
        data: {
            beneficiaryId: beneficiary2.id,
            eventType: client_1.BeneficiaryEventType.EDUCATION,
    ...
    await prisma.beneficiaryTimelineEvent.create({
        data: {
            beneficiaryId: beneficiary3.id,
            eventType: client_1.BeneficiaryEventType.JOINED,
    ...
    await prisma.donorFamilyMember.createMany({
        data: [
            {
                donorId: donor1.id,
                relationType: client_1.FamilyRelationType.SPOUSE,
                name: 'Sunita Sharma',
                birthMonth: 7,
                birthDay: 22,
            },
            {
                donorId: donor1.id,
                relationType: client_1.FamilyRelationType.CHILD,
                name: 'Amit Sharma',
                birthMonth: 1,
                birthDay: 10,
            },
        ...
        data: [
            {
                ...
                donationType: client_1.DonationType.CASH,
                donationMode: client_1.DonationMode.BANK_TRANSFER,
            ...
            },
            {
                ...
                donationType: client_1.DonationType.GROCERY,
                donationMode: client_1.DonationMode.UPI,
            ...
            },
            {
                ...
                donationType: client_1.DonationType.CASH,
                donationMode: client_1.DonationMode.GPAY,
            ...
            },
            {
                ...
                donationAmount: 5000,
                donationType: client_1.DonationType.CASH,
                donationMode: client_1.DonationMode.CASH,
    ...
    await prisma.pledge.createMany({
        data: [
            {
                donorId: donor1.id,
                pledgeType: client_1.PledgeType.MONEY,
                amount: 50000,
            ...
            {
                donorId: donor2.id,
                pledgeType: client_1.PledgeType.RICE,
            ...
            {
                donorId: donor1.id,
                pledgeType: client_1.PledgeType.MEAL_SPONSOR,
    ...
    const defaultTemplates = [
        {
            type: client_1.TemplateType.THANK_YOU,
...
Asha Kuteer Foundation Team`,
        ...
        {
            type: client_1.TemplateType.GENTLE_FOLLOWUP,
...
Asha Kuteer Foundation Team`,
        ...
        {
            type: client_1.TemplateType.MONTHLY_REMINDER,
...
Asha Kuteer Foundation Team`,
        ...
        {
            type: client_1.TemplateType.FESTIVAL_GREETING,
...
Asha Kuteer Foundation Team`,
        ...
        {
            type: client_1.TemplateType.RECEIPT_RESEND,
...
Asha Kuteer Foundation Team`,
        ...
        {
            type: client_1.TemplateType.BIRTHDAY_ANNIVERSARY,
...
Asha Kuteer Foundation Team`,
    ...
    await prisma.messageTemplate.upsert({
        where: { key_channel: { key: 'DONOR_BIRTHDAY_WISH', channel: client_1.MessageChannel.WHATSAPP } },
        update: {},
        create: {
...
{{org_name}}`,
    ...
    await prisma.messageTemplate.upsert({
        where: { key_channel: { key: 'DONOR_BIRTHDAY_WISH', channel: client_1.MessageChannel.EMAIL } },
        update: {},
        create: {
            key: 'DONOR_BIRTHDAY_WISH',
...
<strong>{{org_name}}</strong></p>
    ...
    await prisma.messageTemplate.upsert({
        where: { key_channel: { key: 'BENEFICIARY_BIRTHDAY_WISH', channel: client_1.MessageChannel.WHATSAPP } },
        update: {},
        create: {
...
{{org_name}}`,
    ...
    await prisma.messageTemplate.upsert({
        where: { key_channel: { key: 'BENEFICIARY_BIRTHDAY_WISH', channel: client_1.MessageChannel.EMAIL } },
        update: {},
        create: {
            key: 'BENEFICIARY_BIRTHDAY_WISH',
            channel: client_1.MessageChannel.EMAIL,
